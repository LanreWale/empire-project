...
import { getWallet } from "../lib/gas";
export default function Wallet(){
  const [data,setData]=React.useState(null); const [err,setErr]=React.useState("");
  React.useEffect(()=>{(async()=>{try{setData(await getWallet());}catch(e){setErr(e.message);}})();},[]);
  return <Tab title="Payments / Wallet" err={err} data={data} />;
}
